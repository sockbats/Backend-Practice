...
class TestKillerEndpoints(unittest.TestCase):
    ...
    def test_post(self):
        delete(self.backend_url + self.endpoint + f"?id={self.killer_id}")

        response = post(self.backend_url + self.endpoint, json=self.killer)
    ...
    def test_get_by_id(self):
        post(self.backend_url + self.endpoint, json=self.killer)

        response = get(self.backend_url + self.endpoint + f"?id={self.killer_id}")
        print(response.json())
    ...
    def test_get_all(self):
        ...
        response = get(self.backend_url + self.endpoint)
        print(response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_put(self):
        ...
        response = put(self.backend_url + self.endpoint + f"?id={self.killer_id}", json=self.killer)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json().get("message"), "1 lines affected.")
    ...
    def test_delete(self):
        ...
        response = delete(self.backend_url + self.endpoint + f"?id={self.killer_id}")
        self.assertEqual(response.status_code, 200)
...
class TestKillerPerkEndpoints(unittest.TestCase):
    ...
    def test_post(self):
        delete(self.backend_url + self.endpoint + f"?id={self.perk_id}")

        response = post(self.backend_url + self.endpoint, json=self.perk)
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.json().get("message"), "1 lines affected.")
    ...
    def test_get_by_id(self):
        post(self.backend_url + self.endpoint, json=self.perk)

        response = get(self.backend_url + self.endpoint + f"?id={self.perk_id}")
        print(response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_put(self):
        ...
        response = put(self.backend_url + self.endpoint + f"?id={self.perk_id}", json=self.perk)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json().get("message"), "1 lines affected.")
    ...
    def test_delete(self):
        ...
        response = delete(self.backend_url + self.endpoint + f"?id={self.perk_id}")
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json().get("message"), "1 lines deleted.")
...
class TestSurvivorEndpoints(unittest.TestCase):
    ...
    def test_post(self):
        delete(self.backend_url + self.endpoint + f"?id={self.survivor_id}")

        response = post(self.backend_url + self.endpoint, json=self.survivor)
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.json().get("message"), "1 lines affected.")
    ...
    def test_get_by_id(self):
        post(self.backend_url + self.endpoint, json=self.survivor)

        response = get(self.backend_url + self.endpoint + f"?id={self.survivor_id}")
        print(response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_put(self):
        ...
        response = put(self.backend_url + self.endpoint + f"?id={self.survivor_id}", json=self.survivor)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json().get("message"), "1 lines affected.")
    ...
    def test_delete(self):
        ...
        response = delete(self.backend_url + self.endpoint + f"?id={self.survivor_id}")
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json().get("message"), "1 lines deleted.")
